...
function AddStudents({students,setStudents}){
            ...
            return(
            <Base> <><><><><><><span className="stud-bar"><h3>Add StudentList</h3><Button onClick={()=>history.push("/Studentlist")} style={{ width: "5vw" }} variant="contained">Back</Button></span><br /><FormControl fullWidth sx={{ m: 1 }} variant="standard">
